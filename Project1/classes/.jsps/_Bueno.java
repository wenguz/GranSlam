        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:39^9*/            {
              ...
              __jsp_taghandler_10.setValue("Registrar Resultados");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:40^9*/            {
              ...
              __jsp_taghandler_11.setValue("Listar Resultados");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:44^9*/            {
              ...
              __jsp_taghandler_12.setValue("Regsitrar Torneo");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:45^9*/            {
              ...
              __jsp_taghandler_13.setValue("Listar Torneo");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:49^9*/            {
              ...
              __jsp_taghandler_14.setValue("Registrar Fase");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:50^9*/            {
              ...
              __jsp_taghandler_15.setValue("Listar Fase");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:54^9*/            {
              ...
              __jsp_taghandler_16.setValue("Registrar Modalidad");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:55^9*/            {
              ...
              __jsp_taghandler_17.setValue("Listar Modalidad");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:55^66*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
